...
##Path to files
#######################################
data_dir = 'D:\Python\PlottingTemProfileWithLabelsAndMarkers/'
#filename = '2.txt'
litersPerHour = ['800', '600', '200']
filepaths = [data_dir + 'ALMEMO' + x + '.001'for x in litersPerHour]
colors = ['m', 'g', 'r']
##temProfileMarkers = pd.DataFrame([["+","o","v","^","<",">","s","p","*","h","x","D","d","1","2","3","4","d","|","X"],
##                     ["+","o","v","^","<",">","s","p","*","h","x","D","d","1","2","3","4","d","|","X"],
##                     ["+","o","v","^","<",">","s","p","*","h","x","D","d","1","2","3","4","d","|","X"]])
##temProfileMarkers = [["+","o","v","^","<",">","s","p","*","h","x","D","d","1","2","3","4","d","|","X"],
##                     ["+","o","v","^","<",">","s","p","*","h","x","D","d","1","2","3","4","d","|","X"],
##                     ["+","o","v","^","<",">","s","p","*","h","x","D","d","1","2","3","4","d","|","X"]]
#listMarkers= pd.DataFrame(["+","o","v","^","<",">","s","p","*","h","x","D","d","1","2","3","4","d","|","X"])
...
pointtypes = ['-.', '-.', '-.']
markers = ['+','x', 'o']
labels = ['800l/h', '600l/h', '200l/h']
out_dir = 'D:\Python\PlottingTemProfileWithLabelsAndMarkers/plots/'
...
def read_data(fpath):
    if fpath == filepaths[0]:
        ...
        df = pd.read_csv(os.path.join(fpath), sep = ";", skiprows = 1400, header = None)
    return df
############################################
...
def multiplot(mixnumber,
    ...
    ttl = ax.title
    ttl.set_weight('bold')
    plt.savefig(outpath + 'plot' + '.png', transparent = False, bbox_inches="tight")
    plt.show()
